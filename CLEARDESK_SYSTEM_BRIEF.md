...
## What It Is
Production-quality accounts receivable document processing dashboard. Users upload real financial documents (invoices, statements, disputes), Claude AI analyzes them server-side, extracts structured data, assigns priority/type, and flags items for escalation. Everything persists in localStorage. Premium dark UI (Bloomberg Terminal aesthetic).
