...
- **Sync** — Share a code to access your documents on any device. Powered by Cloudflare KV. No account required.
...
If Cloudflare variables are not set, the app works normally with localStorage only — no errors, no broken features.
